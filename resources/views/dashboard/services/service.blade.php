...
@endphp
@section('content')
@if (empty($userBooking) || !$userBooking->isNotEmpty())
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-2">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control wide mb-3 {{ $isInvalid }}" id="vehicle-dropdown" name="vehicle_id">
...
@elseif (!empty($bookingUnderway) && !$userBooking->isNotEmpty())
<div class="content-body">
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <div class="card">
                    ...
                    <div class="card-header d-block mb-4">
                        ...
                        <span class="btn-sm btn-dark mt-4">
                            @foreach ($formattedBookingUnderway as $booking)
