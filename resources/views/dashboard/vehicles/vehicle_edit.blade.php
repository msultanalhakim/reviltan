@section('page_title', 'Reviltan - Vehicle Update')
            ...
            <div class="col-xl-8 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"><a href="{{ route('vehicle') }}"><i class="fas fa-arrow-left"></i></a> Update Vehicle</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="POST" action="{{ route('vehicle.update.store') }}">
                                @csrf
                                <div class="row mb-2">
                                    ...
                                    <div class="mb-3 col-md-12">
                                        ...
                                        <div class="basic-form">
                                            <select class="@error('customer_id') is-invalid @enderror" name="customer_id" id="single-select" style="border:0.5rem solid #fff">
                                                <option value="{{ $vehicle->customer_id }}">{{ $vehicle->email }}</option>
                                ...
                                <button type="submit" class="btn btn-primary btn-sm mt-3" id="submit-button">Update</button>
                            </form>
                        </div>
                    </div>
                </div>
